...
LabelledPost.create!(label_id: 7, post_id:1)
LabelledPost.create!(label_id: 4, post_id:3)
LabelledPost.create!(label_id: 1, post_id:4)
LabelledPost.create!(label_id: 2, post_id:2)